...
public class AdminController {
    ...
    public ResponseEntity<Void> adminChangeItemStatus(){
    ...
    public ResponseEntity<Void> adminCheckItemList(){
        return ResponseEntity.ok().build();
    }
    ...
    public ResponseEntity<Void> adminAddItem(){
        return ResponseEntity.ok().build();
    }
    ...
    public ResponseEntity<Void> adminDeleteItem(){
        return ResponseEntity.ok().build();
    }
    ...
    public ResponseEntity<Void> adminItemDetail(){
        return ResponseEntity.ok().build();
    }
}
